    ...
    const menuSections = [
        {
            ...
            items: [
                ...
                {
                    icon: "information",
                    label: "About SevaSethu",
                    color: Colors.textSecondary,
                    onPress: () => navigation.navigate("AboutSevaSethu"),
                },
                {
                    icon: "help-circle",
                    label: "Help & Support",
        ...
        >
                ...
                <View style={styles.profileRow}>
                    ...
                    <View style={styles.profileInfo}>
                        ...
                        <View style={styles.levelRow}>
                            ...
                            />
                            <Text
                                style={[styles.levelText, { color: C.warning }]}
                            >
                                {user.level} Donor
                            </Text>
                        </View>
            ...
            >
                <View style={styles.toggleLeft}>
                    ...
                    <View>
                        ...
                        >
                            {user.isAvailable
                                ? "You'll receive nearby requests"
            ...
            >
                ...
                <Switch
                    ...
                    thumbColor={
                        notificationsEnabled ? C.warning : C.textTertiary
                    }
                />
            </View>
                ...
                <View style={styles.toggleLeft}>
                    ...
                    >
                        <Icon
                            ...
                            size={24}
                            color={isDarkMode ? C.primary : C.warning}
                        />
                    </View>
                    <View>
                        <Text
