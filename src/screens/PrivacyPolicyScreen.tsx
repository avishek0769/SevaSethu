  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: bg }]} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <LinearGradient colors={headerGradient} style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: C.textOnPrimary }]}>Privacy Policy</Text>
        <Text style={[styles.headerSub, { color: isDarkMode ? 'rgba(255,255,255,0.7)' : 'rgba(255,255,255,0.8)' }]}>How SevaSethu handles your information.</Text>
      </LinearGradient>
      ...
      <View style={styles.body}>
        ...
        <AppCard style={styles.sectionCard}>
          <Text style={[styles.sectionTitle, { color: C.textPrimary }]}>Contact</Text>
          <Text style={[styles.sectionBody, { color: C.textSecondary }]}>If you have questions about privacy, reach out through Help & Support or update your preferences in the app.</Text>
        </AppCard>
      </View>
    </ScrollView>
  );
