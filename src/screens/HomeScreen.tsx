    ...
    return (
        ...
        >
            ...
            <LinearGradient colors={headerGradient} style={styles.hero}>
                <View style={styles.heroTop}>
                    <View style={styles.heroLeft}>
                        ...
                        <Text
                            style={[styles.heroSub, { color: C.textSecondary }]}
                        >
                ...
                <AppCard style={styles.heroCard}>
                    ...
                    <Switch
                        ...
                        thumbColor={
                            user.isAvailable ? C.success : C.textTertiary
                        }
                    />
                </AppCard>
            </LinearGradient>
            ...
            <SectionHeader
                ...
                actionText="See All"
                onAction={() => navigation.navigate("NearbyBloodBanks")}
            />
            {bloodBanks.slice(0, 3).map((bank) => (
                <TouchableOpacity
                    key={bank.id}
                    activeOpacity={0.8}
                    onPress={() => navigation.navigate("NearbyBloodBanks")}
                >
                        ...
                        <View style={styles.bankTop}>
                            ...
                            >
                                <Icon
                                    ...
                                    size={24}
                                    color={
                                        bank.isOpen ? C.success : C.textTertiary
                                    }
                                />
                            </View>
                ...
                {leaderboardData.slice(0, 3).map((entry, i) => (
                    ...
                    >
                        ...
                        <View style={styles.leaderInfo}>
                            ...
                            >
                                {entry.donations} donations · {entry.city}
                            </Text>
                        </View>
                        <BloodGroupBadge
