...
const DonorRegistrationScreen: React.FC<{ navigation: any }> = ({
    navigation,
}) => {
            ...
            case 2:
                return (
                    <View>
                        ...
                        <Text style={styles.stepSub}>
                            Help us find the right matches
                        </Text>
            ...
            case 3:
                return (
                    <View>
                        ...
                        <Text style={styles.stepSub}>
                            So we can find requests near you
                        </Text>
                        <View style={styles.inputGroup}>
            ...
            <View style={styles.form}>
                ...
                >
                    <LinearGradient
                        ...
                        style={[styles.nextBtn, Shadow.red]}
                    >
                        ...
                        <Icon
                            name={step < totalSteps ? "arrow-right" : "check"}
                            size={20}
