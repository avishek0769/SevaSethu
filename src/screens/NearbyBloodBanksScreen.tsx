...
const NearbyBloodBanksScreen: React.FC<{ navigation: any }> = ({
    navigation,
}) => {
        ...
        >
            ...
            <LinearGradient colors={headerGradient} style={styles.header}>
                ...
                <Text style={styles.headerSub}>
                    {bloodBanks.length} blood banks found near you
                </Text>
            </LinearGradient>
                        ...
                        <AppCard key={bank.id} style={styles.bankCard}>
                            ...
                            <View style={styles.actionRow}>
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() =>
                                        Linking.openURL(
                                            `https://maps.google.com/?q=${bank.latitude},${bank.longitude}`,
                                        )
                                    }
                                >
                                    <Icon
