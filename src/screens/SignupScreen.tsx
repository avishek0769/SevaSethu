...
const SignupScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    const renderStepOne = () => (
        <View>
            ...
            <Text style={[styles.stepSub, { color: C.textSecondary }]}>
                Start with the basics, then you can complete donor details.
            </Text>
    ...
    const renderStepTwo = () => (
        <View>
            ...
            <Text style={[styles.stepSub, { color: C.textSecondary }]}>
                Add the matching details now, or skip this step and finish
                later.
            </Text>
                            ...
                            styles.bgChip,
                            {
                                backgroundColor:
                                    bloodGroup === group
                                        ...
                                        : C.surfaceVariant,
                                borderColor:
                                    bloodGroup === group ? C.primary : C.border,
                            },
                        ]}
                ...
                {GENDERS.map((option) => (
                            ...
                            styles.genderChip,
                            {
                                backgroundColor:
                                    gender === option
                                        ...
                                        : C.surfaceVariant,
                                borderColor:
                                    gender === option ? C.primary : C.border,
                            },
                        ]}
                    ...
                    >
                        <Icon
                            ...
                            size={18}
                            color={
                                gender === option ? C.primary : C.textTertiary
                            }
                        />
                        <Text
                            style={[
            ...
            >
                <View style={{ flex: 1 }}>
                    ...
                    >
                        You can adjust this later from your profile.
                    </Text>
                </View>
                <Switch
                    value={available}
            ...
            <View style={{ marginTop: 16 }}>
                <AppButton
                    title={loading ? "Saving..." : "Complete Signup"}
