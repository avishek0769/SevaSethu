...
const initialMessages: ChatMessage[] = [
    ...
    {
        id: "c2",
        text: "Can I donate blood if I have a cold?",
        isBot: false,
        timestamp: "10:01 AM",
    },
    {
        id: "c3",
        text: "Great question! If you have a mild cold without fever, you may still be able to donate. However, if you have a fever, sore throat, or are on antibiotics, it's best to wait until you're fully recovered. Usually, 7 days after symptoms resolve is recommended.",
        isBot: true,
        timestamp: "10:01 AM",
    },
    {
        id: "c4",
        text: "How often can I donate blood?",
        isBot: false,
        timestamp: "10:02 AM",
    },
    {
        id: "c5",
        text: "You can donate whole blood every 56 days (about 8 weeks). Platelet donors can give every 7 days, up to 24 times a year. Your body replenishes blood volume within 48 hours! 💪",
        isBot: true,
        timestamp: "10:02 AM",
    },
    {
        id: "c6",
        text: "What should I eat before donating?",
        isBot: false,
        timestamp: "10:03 AM",
    },
    {
        id: "c7",
        text: "Before donating, eat iron-rich foods like spinach, red meat, or beans. Drink plenty of water (at least 16 oz). Avoid fatty foods as they can affect blood tests. A light, healthy meal 2-3 hours before is ideal! 🥗",
        isBot: true,
        timestamp: "10:03 AM",
    },
];
...
const proactiveMessage =
    "I can automatically send reminders while you browse other sections. Open any request if you need a quick follow-up.";
...
const buildInitialThreads = (): ChatThread[] => [
    ...
    },
    {
        ...
        messages: [
            {
                id: "elig-1",
                text: "Can I donate if I recovered from a fever recently?",
                isBot: false,
                timestamp: "Yesterday",
            },
            {
                id: "elig-2",
                text: "If you have been fever-free for a few days and feel well, you may be eligible. If you were on antibiotics, wait a little longer and check with the donation centre.",
                isBot: true,
                timestamp: "Yesterday",
            },
            {
            ...
            {
                id: "elig-4",
                text: "A light meal, plenty of water, and iron-rich food are the safest choices before donation.",
                isBot: true,
                timestamp: "Yesterday",
            },
        ],
    },
    {
        ...
        messages: [
            {
                id: "banks-1",
                text: "Show me the closest blood banks around me.",
                isBot: false,
                timestamp: "Today",
            },
            {
                id: "banks-2",
                text: "I can help shortlist the nearest centres and mark which ones are open right now.",
                isBot: true,
                timestamp: "Today",
            },
            {
                id: "banks-3",
                text: "Do any of them take walk-ins?",
                isBot: false,
                timestamp: "Today",
            },
            {
                id: "banks-4",
                text: "Yes. I can flag the ones that are open and ready for walk-in donors.",
                isBot: true,
                timestamp: "Today",
            },
        ],
    },
    {
        ...
        messages: [
            {
                id: "rem-1",
                text: "Will the requester get a note after donation is confirmed?",
                isBot: false,
                timestamp: "Today",
            },
            {
                id: "rem-2",
                text: "Yes. Once the donor has donated, the requester sees the completion note, certificate status, and token update.",
                isBot: true,
                timestamp: "Today",
            },
        ],
...
const ChatbotScreen: React.FC = () => {
    ...
    const appendMessage = useCallback(
        (threadId: string, message: ChatMessage, markUnread = false) => {
        ...
        return (
            ...
            >
                ...
                <View style={styles.threadCopy}>
                    <Text
                        style={[styles.threadTitle, { color: C.textPrimary }]}
                        numberOfLines={1}
                    >
                        {item.title}
                    </Text>
                ...
                <View style={styles.threadMeta}>
                    <Text
                        style={[styles.threadTime, { color: C.textTertiary }]}
                    >
    ...
    const quickActions = [
        {
            label: "🩸 Donation Tips",
            msg: "What are some tips for blood donation?",
        },
