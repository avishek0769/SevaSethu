...
const RequestDetailsScreen: React.FC<{ navigation: any; route: any }> = ({
    ...
    const matchingBanks = bloodBanks.filter((bank) =>
        bank.availableGroups.includes(request.bloodGroup),
    );
        ...
        >
            ...
            <LinearGradient colors={headerGradient} style={styles.header}>
                ...
                <Text style={styles.headerSub}>
                    Everything you need to revisit this request.
                </Text>
            </LinearGradient>
            ...
            <View style={styles.body}>
                <AppCard style={styles.summaryCard}>
                    <View style={styles.summaryTop}>
                        ...
                        <View style={styles.summaryInfo}>
                            ...
                            <Text style={styles.summarySub}>
                                {requestType === "urgent"
                                    ? `${request.units} unit${request.units > 1 ? "s" : ""} needed urgently`
                ...
                {acceptedDonors.length === 0 ? (
                    <AppCard style={styles.emptyCard}>
                        ...
                        <Text style={styles.emptyText}>
                            Accepted donors will appear here. For scheduled
                            requests, this is the only list you need to revisit.
                        </Text>
                    </AppCard>
                ) : (
                            ...
                            <View style={styles.acceptedTop}>
                                <View style={styles.acceptedLeft}>
                                    <View style={styles.acceptedRank}>
                                        <Text style={styles.acceptedRankText}>
                                            ✓
                                        </Text>
                                    </View>
                                    <View style={{ flex: 1 }}>
                ...
                {matchingDonors.length === 0 ? (
                    ...
                    >
                        ...
                        >
                            Looking for compatible donors nearby...
                        </Text>
                    </View>
                ) : (
                    <ScrollView
            ...
            <ConfirmationDialog
                ...
                message={
                    rejectDialog
                        ? `This will remove ${rejectDialog.donorName} from the accepted list and add a polite note to history.`
                        : ""
                }
                icon="account-remove"
                ...
                onConfirm={() =>
                    rejectDialog
                        ? handleRejectAcceptance(
                              rejectDialog.donorId,
                              rejectDialog.donorName,
                          )
                        : setRejectDialog(null)
                }
            />
