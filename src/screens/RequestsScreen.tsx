...
const RequestsScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    const filteredUrgent = (
        selectedFilter === "All"
            ? urgentRequests
            : urgentRequests.filter((r) => r.bloodGroup === selectedFilter)
    ).filter((r) =>
        matchesSearch([
            r.patientName,
            r.bloodGroup,
    ...
    const filteredScheduled = (
        selectedFilter === "All"
            ? scheduledRequests
            : scheduledRequests.filter((r) => r.bloodGroup === selectedFilter)
    ).filter((r) =>
        matchesSearch([
            r.bloodGroup,
            r.hospital,
    ...
    const buildDonorAcceptance = () => ({
        ...
        phone: user.phone,
        lastDonation:
            user.lastDonation || new Date().toISOString().split("T")[0],
        totalDonations: user.totalDonations,
    });

    const handleAcceptRequest = (
        requestType: "urgent" | "scheduled",
        request: (typeof urgentRequests)[0] | (typeof scheduledRequests)[0],
    ) => {
        ...
        setDialog({
            ...
            onConfirm: () => {
                ...
                setDialog({
                    title: "Accepted",
                    message:
                        "Your response has been recorded for the requester.",
                    icon: "check-circle",
            ...
            <View style={styles.cardHeader}>
                <View style={styles.cardHeaderLeft}>
                    ...
                    <View style={styles.cardHeaderInfo}>
                        ...
                        <Text
                            style={[styles.reqSub, { color: C.textSecondary }]}
                        >
                            {item.units} unit{item.units > 1 ? "s" : ""} needed
                        </Text>
                    </View>
                </View>
            </View>
    ...
    const renderScheduledCard = ({
        ...
        item: (typeof scheduledRequests)[0];
    }) => (
        <AppCard style={styles.reqCard}>
            <View style={styles.cardHeader}>
                <View style={styles.cardHeaderLeft}>
                ...
                <View
                    style={[styles.dateChip, { backgroundColor: C.infoLight }]}
                >
        ...
        <View style={[styles.container, { backgroundColor: bg }]}>
            ...
            <LinearGradient colors={headerGradient} style={styles.header}>
                ...
                <Text style={[styles.headerSub, { color: C.textSecondary }]}>
                    {urgentRequests.length} urgent · {scheduledRequests.length}{" "}
                    scheduled
                </Text>
            </LinearGradient>
                ...
                {(["urgent", "scheduled"] as const).map((tab) => (
                    ...
                    >
                        <Icon
                            ...
                            size={18}
                            color={
                                activeTab === tab ? C.primary : C.textTertiary
                            }
                        />
                        <Text
                            style={[
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <EmptyState
                            ...
                            message="Try another blood group or clear the search."
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <EmptyState
                            ...
                            title="No scheduled requests found"
                            message="Try another blood group or clear the search."
                            actionText="Reset Filters"
                            onAction={clearFilters}
                        />
            ...
            <ConfirmationDialog
                ...
                confirmColors={
                    dialog?.confirmColors ||
                    (C.gradientPrimary as [string, string])
                }
