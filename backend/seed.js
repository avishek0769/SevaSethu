...
const bloodBanksData = [
    {
        ...
        phone: "+91 33 2229 5050",
        availableGroups: ["A+", "A-", "B+", "O+", "O-", "AB+"],
        isOpen: true,
        openHours: "24 Hours",
        rating: 4.8,
        latitude: 22.5507,
    ...
    },
    {
        ...
        phone: "+91 33 2223 6070",
        availableGroups: ["A+", "B+", "B-", "O+", "AB+", "AB-"],
        isOpen: true,
...
const badgesData = [
    ...
    },
    {
        ...
        icon: "lightning-bolt",
        description: "Accept 3 urgent requests",
        maxProgress: 3,
        color: "#EF4444",
    },
    {
    ...
    },
    {
        ...
        icon: "calendar-star",
        description: "Donate on 3 weekends",
        maxProgress: 3,
        color: "#0891B2",
    },
    {
    ...
    },
    {
        name: "Blood Brother",
        icon: "account-group",
        description: "Help 10 different requesters",
        maxProgress: 10,
        color: "#EC4899",
    },
];
    ...
    try {
        ...
        const userBadgesData = badges.map((b, i) => ({
            ...
            progress:
                i < 4
                    ? b.maxProgress
                    : Math.floor(Math.random() * b.maxProgress),
        ...
        const urgentRequests = [
            {
                ...
                requester: mainRequester._id,
                requesterName: mainRequester.name,
            },
            {
                type: "urgent",
                ...
                notes: "Accident victim, urgent need",
                requester: mainRequester._id,
                requesterName: mainRequester.name,
            },
            {
                type: "urgent",
                patientName: "Mohit Jha",
                bloodGroup: "B+",
                units: 3,
                ...
                notes: "Thalassemia patient",
                requester: donors[1]._id,
                requesterName: donors[1].name,
            },
            {
                type: "urgent",
                ...
                bloodGroup: "AB-",
                units: 1,
                hospital: "Ruby General",
                address: "EM Bypass, Kolkata",
                urgency: "medium",
                contact: "+91 98765 00004",
                notes: "",
                requester: donors[2]._id,
                requesterName: donors[2].name,
            },
            {
                type: "urgent",
                patientName: "Rohan Ghosh",
                bloodGroup: "O-",
                units: 2,
        ...
        const scheduledRequests = [
            ...
            },
            {
                ...
                address: "Loudon Street, Kolkata",
                urgency: "low",
                contact: "+91 98765 10002",
                notes: "Regular transfusion",
                date: "2026-05-12",
                time: "2:00 PM",
                requester: donors[3]._id,
                requesterName: donors[3].name,
            },
            {
                type: "scheduled",
                bloodGroup: "O+",
                ...
                date: "2026-05-15",
                time: "9:00 AM",
                requester: donors[0]._id,
                requesterName: donors[0].name,
            },
        ];
        ...
        const historyData = [
            {
                ...
                isVerified: true,
                tokensEarned: 40,
                description: "Donated 1 unit at SSKM Hospital",
                user: primaryUser._id,
            ...
            },
            {
                ...
                isVerified: true,
                tokensEarned: 80,
                description: "Donated 2 units at Apollo Gleneagles",
                user: primaryUser._id,
                certificateAvailable: true,
            },
            {
                ...
                isVerified: false,
                tokensEarned: 0,
                description: "Accepted urgent request. Awaiting approval.",
                user: primaryUser._id,
                approvalNote: "Pending requester confirmation",
            },
            {
                type: "donated",
                bloodGroup: "O+",
                ...
                isVerified: true,
                tokensEarned: 40,
                description: "Emergency donation at Medica Hospital",
                user: primaryUser._id,
                certificateAvailable: true,
            },
            {
                ...
                isVerified: true,
                tokensEarned: 100,
                description: "Bonus: Reached Gold donor level!",
                user: primaryUser._id,
            },
        ];
        ...
        const notifsData = [
            {
                ...
                message:
                    "A patient at SSKM Hospital needs O+ blood urgently. You're a match!",
                type: "urgent",
                icon: "alert-circle",
            },
            {
                ...
                message:
                    "Congratulations! You've unlocked the 'Blood Champion' badge for 10 donations.",
                type: "reward",
                icon: "star-circle",
            },
            {
            ...
            },
            {
                ...
                message:
                    "O- blood is running low at Red Cross Blood Bank. Consider donating if available.",
                type: "stock",
                icon: "alert",
            },
            {
                ...
                message:
                    "Thank you for joining. Complete your profile to start receiving donation requests.",
                type: "general",
                icon: "information",
            },
            {
                ...
                message:
                    "A new A+ blood request has been posted within 5 km of your location.",
                type: "urgent",
            ...
            },
            {
                ...
                title: "Tokens Earned! ⭐",
                message:
                    "You earned 80 tokens for your recent donation. Keep up the amazing work!",
                type: "reward",
                icon: "star",
            },
        ];
