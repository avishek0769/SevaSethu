...
export default function App() {
  ...
  const {
    mint, fetchDonations,
    minting, txHash, tokenId, step, error: mintError,
  } = useContract(signer)
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 680, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <div style={{
            ...
            fontWeight: 700, color: '#e74c3c', letterSpacing: '.06em'
          }}>🩸 LifeLine</div>
          <div style={{
            fontSize: 11, fontFamily: "'Share Tech Mono',monospace",
            color: '#a07080', letterSpacing: '.22em', marginTop: 3
          }}>NFT BLOOD DONATION CERTIFICATE</div>
        </div>
        ...
        <div style={{ height: 1, background: 'linear-gradient(90deg,transparent,#3a1510,transparent)', margin: '20px 0' }} />
        ...
        {/* ── LOADING ── */}
        {minting && (
          <MintLoader step={step} txHash={txHash} />
        )}

        {/* ── MINT ERROR ── */}
        {mintError && (
          <div style={{
            background: '#1a0608', border: '1px solid #c0392b',
            borderRadius: 8, padding: '12px 16px', marginBottom: 16,
            color: '#f5a0b0', fontSize: 13,
        ...
        {certData && !minting && (
          <>
            ...
            <button
              ...
              style={{
                background: 'transparent', border: '1px solid #3a1a20',
                borderRadius: 6, color: '#a07080', padding: '8px 16px',
        ...
        <div style={{ height: 1, background: 'linear-gradient(90deg,transparent,#3a1510,transparent)', margin: '8px 0 20px' }} />
      ...
      {toast && (
        <div style={{
          ...
          background: '#1a080e', border: '1px solid #c0392b',
