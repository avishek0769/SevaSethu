...
export default function Certificate({ data, tokenId, txHash, wallet }) {
    ...
    return (
        <div
            id="certificate-root"
            style={{ marginBottom: 20, animation: "fadeUp .6s ease" }}
        >
            {/* Status badges */}
            <div
                style={{
            ...
            <div
                style={{
                    ...
                    borderRadius: 14,
                    background:
                        "linear-gradient(135deg,#d4af37,#8b0000,#d4af37,#8b0000,#d4af37)",
                }}
            >
                {/* Certificate body */}
                <div
                    style={{
                        background:
                            "linear-gradient(160deg,#130810 0%,#0d0508 50%,#130810 100%)",
                        borderRadius: 12,
