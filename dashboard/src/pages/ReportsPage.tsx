    ...
    <div className="grid gap-6">
      <Card>
        <CardHeader>
          ...
          <div className="flex items-center gap-2">
            <Button variant="secondary" onClick={() => exportUIOnly("CSV")}>Export CSV</Button>
            <Button variant="secondary" onClick={() => exportUIOnly("PDF")}>Export PDF</Button>
          </div>
        </CardHeader>
      </Card>
        ...
        <Table>
          ...
          <tbody>
            {[
              ...
              <tr key={row.m} className="hover:bg-[var(--surface-2)]/60">
      ...
      <Card>
        ...
        <Table>
          ...
          <tbody>
            {[
              { t: "Today", a: "Donation verified", by: "Admin", to: "d_2" },
              { t: "Yesterday", a: "User flagged", by: "Admin", to: "u_5" },
              { t: "2 days ago", a: "Request escalated", by: "Admin", to: "r_1" },
            ].map((row, idx) => (
              <tr key={idx} className="hover:bg-[var(--surface-2)]/60">
