...
export function LeaderboardPage() {
    ...
    const [category, setCategory] =
        useState<LeaderboardCategory>("individuals");

    const rows = useMemo(() => {
        return category === "individuals"
            ? state.leaderboardIndividuals
            : state.leaderboardBanks;
            ...
            <Card>
                <CardHeader>
                    <div>
                        ...
                        <CardMeta>
                            Individuals + blood banks — city/state/country
                            (mock)
                        </CardMeta>
                    </div>
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="ml-auto text-sm text-[var(--fg-2)]">
                        Scope: {scope}
                    </div>
                </div>
            </Card>
                    ...
                    <Card key={r.id} className="p-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                <div className="truncate text-xs text-[var(--fg-2)]">
                                    {r.scopeLabel}
                                </div>
                            </div>
