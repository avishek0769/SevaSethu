...
export function AnalyticsPage() {
  ...
  return (
    <div className="grid gap-6">
      <Card>
        <CardHeader>
          <div>
            ...
            <CardMeta>Demand vs supply + trends (simple charts)</CardMeta>
          </div>
        </CardHeader>
      </Card>
      ...
      <LineChartCard title="Weekly Trend" subtitle="Overall activity" labels={trends.labels} data={trends.data} />
    </div>
  );
}
