        ...
        return state.users.filter((u) => {
            if (q.trim()) {
                ...
                if (
                    ...
                    !u.locationLabel.toLowerCase().includes(s)
                )
                    return false;
            }
            if (bloodGroup !== "all" && u.bloodGroup !== bloodGroup)
                return false;
                ...
                <tbody>
                    {filtered.map((u) => (
                        ...
                        >
                            ...
                            <Td className="capitalize text-[var(--fg-2)]">
                                {u.role}
                            </Td>
                            <Td>
                                <Badge
                            ...
                            <Td className="text-right">
                                <div className="flex justify-end gap-2">
                                    ...
                                    <Button
                                        variant={
                                            u.isFlagged ? "secondary" : "danger"
                                        }
                                        size="sm"
                                        onClick={() => actions.flagUser(u.id)}
                                    >
                ...
                <Card>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <div className="mt-1 text-sm font-semibold">
                                {selected.city} • {selected.locationLabel}
                            </div>
                        </div>
                    </div>
                </Card>
